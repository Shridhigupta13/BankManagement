...
![Login Page](https://github.com/Shridhigupta13/BankManagement/blob/main/login.png)
...
![Main Page](https://github.com/Shridhigupta13/BankManagement/blob/main/BalanceEnquiry.png)

- Addition of new customer and then creating account for the customer.

  ![Add Customer](https://github.com/Shridhigupta13/BankManagement/blob/main/New%20User%201.png)

  ![Add Account](https://github.com/Shridhigupta13/BankManagement/blob/main/New%20User%202.png)

  ![Add Account](https://github.com/Shridhigupta13/BankManagement/blob/main/New%20User%203.png)

**Transaction Page:** 
The user can perform two actions i.e. withdrawing on his
account. On loading of withdraw page.

![Withdraw Page](https://github.com/Shridhigupta13/BankManagement/blob/main/Deposit%20Balance.png)


**Report Page:** It displays all the details of the customer to the administrator.

![Report Page](https://github.com/Shridhigupta13/BankManagement/blob/main/Database%20connection.png)

**Balance Page:** It displays the account balance of the selected customer.

![Balance Page](https://github.com/Shridhigupta13/BankManagement/blob/main/Check%20Balance.png)
